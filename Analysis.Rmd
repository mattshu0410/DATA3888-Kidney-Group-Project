...
get_jaccard = function(v1, v2) {
    ...
    union_length = length(union(v1, v2))
...
for (i in 1:length(ABMR_features)){
  for (j in i+1:length(ABMR_features)){
    #print(i)
    #print(j)
    print(ABMR_features[i])
    print(ABMR_features[j])
    jaccard_index = get_jaccard(ABMR_features[i], ABMR_features[j])
    print(as.character(jaccard_index))
    append(jaccard_indexes, jaccard_index)
  }
}
